...
public class EditarComentarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String texto = request.getParameter("c_texto");
        
        Comentario comentario = new Comentario();
        comentario.setId(id);
        comentario.setTexto(texto);
        
        base.modificarComentario(comentario);
                             
        response.sendRedirect(getServletContext().getContextPath() + "MostrarComentariosServlet?c_usuario=" + usuario);
