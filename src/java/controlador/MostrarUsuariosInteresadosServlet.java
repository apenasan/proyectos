 ...
 */
public class MostrarUsuariosInteresadosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listaInteresados = base.listaInteresados(id);
        request.getSession().setAttribute("listaInteresados",listaInteresados);
        request.getSession().setAttribute("oferta",oferta);
        response.sendRedirect(getServletContext().getContextPath() + "/admin/interesados.jsp");
