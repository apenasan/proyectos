 ...
 */
public class MostrarRespuestasCuestionarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(cuestionario == null){
            ...
            for(int i = 0;i < cuestionario.getListaPreguntas().size();i++){
                respuesta = base.getRespuesta(usuario, cuestionario.getListaPreguntas().get(i).getId());
        ...
        response.sendRedirect(getServletContext().getContextPath() + "/admin/respuestas.jsp");
