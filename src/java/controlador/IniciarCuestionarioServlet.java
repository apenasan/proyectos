 ...
 */
public class IniciarCuestionarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idOferta = Integer.parseInt(request.getParameter("i_oferta"));
        BaseDeDatos base = BaseDeDatos.getInstancia();
        
        Cuestionario cuestionario = base.getCuestionarioPorOferta(idOferta);
        
        if(cuestionario == null){
            response.sendRedirect(getServletContext().getContextPath() + "InteresadoServlet?i_usuario=" + usuario + "&i_oferta=" + idOferta);
        } else {
            ...
            response.sendRedirect(getServletContext().getContextPath() + "/open/cuestionario.jsp");
